...
namespace Automata_DTaylor_FinancialPortal.Controllers
{
    ...
    public class InvitationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,Used")] Invitation invitation)
        {
        ...
        public ActionResult AcceptInvite(string code, string email)
        {
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,Used")] Invitation invitation)
        {
            if (ModelState.IsValid)
            {
